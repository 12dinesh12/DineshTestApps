...
namespace IAssetTechnicalTest
{
    public class WebApiApplication : System.Web.HttpApplication
    {
        protected void Application_Start()
        {
            ...
            //Setup IOC for dependency Injection using Ninject Modules
            var kernel = new StandardKernel(new NinjectWebCommon());
            GlobalConfiguration.Configuration.DependencyResolver = kernel.Get<System.Web.Http.Dependencies.IDependencyResolver>();

            //var mailSender = kernel.Get<IGlobalWeatherService>();
        }
    }
}
